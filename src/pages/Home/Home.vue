<template>
  <div class="content">
    ...
    <div class="document-content">
      <div class="content-box" :class="[ mode && 'pl-2 pr-2 pt-1' ]" v-if="fileList.length > 0 || grouping.length > 0">
        <ul class="dispaly warp ul-radio" v-if="mode">

          <li class="wenjian-item pr-2 pl-2 ml-1 pt-2 pb-1 text-center mt-1"
            ...
            <el-row style="width: 100%;">
              <el-col :span="10" >
                <div class="dispaly-flex">
                  ...
                  <div class="list-item-hover pr-3" v-show="currentlyMoving === file.f_id">
      ...
      <Mark :is-show="isShowAlert">
        <div class="alert p2">
          ...
          <div class="alert-body dispaly-center mt-2">
            ...
            <el-input size="mini" v-model="floaderName"></el-input>
          </div>
...
import { createFloader, dowFile, uploadHistory } from '../../api/file'
  ...
  export default {
    ...
    methods: {
      ...
      subCheck() {
        ...
        if(selectMultiple.length === 0 && checkedFile.length === 0 && !selectSingleOne) { return this.$message({ type: 'error', message: '还没选择文件哟！' }) }
      },
      ...
      dowServer(file_id) {
        const file = this.fileList.filter(file => file.f_id === file_id)[0]
